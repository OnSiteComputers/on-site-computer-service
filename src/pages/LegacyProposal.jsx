...
/* ============================================================
   ...
   ACTION LINKS
   ============================================================ */
const PAY_PLAN_A = "https://securelink-prod.valorpaytech.com:4430/?redirect=1&uid=a0efecc9-6bce-11f1-8d9b-128462456e49"; // $349.99 / Trips Included
const PAY_PLAN_B = "https://securelink-prod.valorpaytech.com:4430/?redirect=1&uid=d011ec0d-6bce-11f1-8d9b-128462456e49"; // $299.99 / Trips Excluded
      ...
      <div className="lp-wrap" style={{ padding: "26px 22px 8px" }}>
        ...
        <div className="flex lp-stack" style={{ gap: 18 }}>
          ...
          <div style={{ flex: 1, background: "#fff", border: `1.5px solid ${C.line}`, borderRadius: 10, padding: 22, display: "flex", flexDirection: "column" }}>
            ...
            <div className="lp-ey" style={{ color: C.gold, fontSize: 11, margin: "5px 0 14px" }}>+ 7% NC sales tax = $374.49/mo</div>
            ...
            <a href={PAY_PLAN_A} target="_blank" rel="noopener noreferrer" className="lp-btn lp-pay">Start Plan A — Pay $374.49/mo →</a>
          </div>
          ...
          <div style={{ flex: 1, background: "#fff", border: `1.5px solid ${C.line}`, borderRadius: 10, padding: 22, display: "flex", flexDirection: "column" }}>
            ...
            <div className="lp-ey" style={{ color: C.gold, fontSize: 11, margin: "5px 0 14px" }}>+ 7% NC sales tax = $320.99/mo</div>
            <ul className="lp-feats" style={{ margin: "0 0 18px", color: "#43352a", fontSize: 14, lineHeight: 1.45, flex: 1 }}>
            ...
            <a href={PAY_PLAN_B} target="_blank" rel="noopener noreferrer" className="lp-btn lp-pay">Start Plan B — Pay $320.99/mo →</a>
          </div>
        </div>
