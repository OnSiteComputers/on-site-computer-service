  ...
  return (
    <div style={{ background: C.cream, color: C.ink, fontFamily: "Inter, system-ui, sans-serif", minHeight: "100vh" }}>
      <style>{`
        ...
        .lp-feats li::before { content:'\2014'; color:${C.gold}; position:absolute; left:0; font-weight:700; }
      ...
      <div style={{ background: C.maroon, borderBottom: `3px solid ${C.gold}` }}>
        <div className="lp-wrap lp-stack" style={{ display: "flex", alignItems: "center", gap: 16, padding: "14px 22px" }}>
          <span className="lp-ey" style={{ background: C.goldBright, color: "#2a1207", padding: "7px 12px", borderRadius: 4, fontSize: 11, fontWeight: 700, whiteSpace: "nowrap" }}>SIGN TONIGHT</span>
          <span style={{ color: "#f3ece0", fontSize: 15.5, lineHeight: 1.4 }}>
            Sign before <b style={{ color: "#fff" }}>midnight tonight</b> and your secure VPN will be <b style={{ color: "#fff" }}>set up and running before end of business tomorrow.</b>
          </span>
        </div>
      </div>
      ...
      <div id="get-started" style={{ background: `linear-gradient(120deg, ${C.maroonDeep}, ${C.maroon})`, margin: "26px 0 0", padding: "36px 0 40px", borderTop: `3px solid ${C.gold}` }}>
        <div className="lp-wrap" style={{ textAlign: "center" }}>
          ...
          <p style={{ color: "#e6d4b6", fontSize: 15, maxWidth: 560, margin: "0 auto 24px", lineHeight: 1.5 }}>
            Download the full agreement to review, sign it online, then start your chosen plan above. Sign tonight and your VPN is running by end of business tomorrow.
          </p>
