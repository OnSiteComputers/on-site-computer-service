        ...
        <div className="max-w-6xl mx-auto px-4 flex flex-col-reverse md:flex-row items-center gap-10 w-full">
          <div className="flex-1 text-center md:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              ...
              <a href="#appointments" className="bg-white text-blue-800 hover:bg-blue-50 font-bold py-4 px-8 rounded-xl text-lg transition-all shadow-lg flex items-center justify-center gap-2">
                <Clock className="w-5 h-5" /> Schedule Appointment
              </a>
            </div>
          </div>
          {/* Logo + Trust Card */}
      ...
      <section id="why-us" className="min-h-[calc(100vh-140px)] flex items-start py-16 md:py-20 bg-[#002868]">
        <div className="max-w-6xl mx-auto px-4 w-full">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { icon: "🩺", title: "He diagnoses first, bills second", desc: "Greg tells you exactly what is wrong and what the repair will cost before any work begins. An honest flat-rate diagnostic and a clear quote up front — no guesswork, no surprises." },
      ...
      <section id="appointments" className="py-16 md:py-24 bg-gradient-to-br from-[#1a2e5a] to-[#2563eb] text-white">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="bg-white text-[#1a2e5a] rounded-2xl shadow-2xl p-8 md:p-10">
            ...
            <div className="mb-6">
              ...
              <a
                ...
                className="block w-full bg-orange-500 hover:bg-orange-600 text-white text-center font-bold py-4 px-8 rounded-xl text-lg transition-all shadow-lg"
              >
                Pay My $25 Deposit
              </a>
            </div>
            ...
            <div>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex flex-col items-center justify-center text-center bg-[#1a2e5a] hover:bg-[#22386e] text-white font-bold py-5 px-4 rounded-xl transition-all"
                >
                ...
                <a
                  href={`tel:${PHONE}`}
                  className="flex flex-col items-center justify-center text-center border-2 border-[#1a2e5a] text-[#1a2e5a] hover:bg-[#1a2e5a] hover:text-white font-bold py-5 px-4 rounded-xl transition-all group"
                >
          ...
          <p className="text-center text-blue-100 text-sm mt-8 max-w-2xl mx-auto italic">
            A note from Greg: After a rising number of no-shows this past year, I had to put a deposit in place to protect everyone's time. It keeps the schedule fair and lets me give each customer the attention their repair deserves — and since it credits toward your diagnostic, it costs you nothing extra to book.
          </p>
        </div>
      </section>
