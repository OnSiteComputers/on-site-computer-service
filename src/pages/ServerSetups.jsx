    ...
    <div className="font-sans text-gray-800 bg-white page-fade-in">
      ...
      <nav id="site-nav" className="bg-blue-50 border-b border-blue-100 sticky top-0 z-50 shadow-sm overflow-visible">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-end justify-between gap-4">
          ...
          <div className="hidden md:flex items-end gap-5 lg:gap-6 text-sm lg:text-[15px] font-semibold text-gray-700 whitespace-nowrap">
            ...
            <a href="/server-setups" className="text-orange-500 transition-colors">Server Setups</a>
        ...
        {menuOpen && (
          <div className="md:hidden bg-blue-50 border-t border-blue-100 px-4 pb-4">
            <div className="flex flex-col text-base font-semibold text-gray-700">
              ...
              <a href="/server-setups" className="py-3 border-b border-blue-100 text-orange-500">Server Setups</a>
      ...
      <section className="bg-gradient-to-br from-[#1a2e5a] to-[#2563eb] text-white pt-10 pb-12 md:pt-14 md:pb-16">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="#server-services" className="border-2 border-white text-white hover:bg-white hover:text-blue-800 font-bold py-4 px-8 rounded-xl text-lg transition-all flex items-center justify-center gap-2">
      ...
      <section className="py-16 md:py-20 bg-gradient-to-br from-[#1a2e5a] to-[#2563eb] text-white">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href={`tel:${PHONE}`} className="bg-orange-500 hover:bg-orange-600 text-white font-bold py-4 px-10 rounded-xl text-lg transition-all shadow-lg flex items-center justify-center gap-2">
              <Phone className="w-5 h-5" /> Call {PHONE}
            </a>
            <a href={`mailto:${EMAIL}`} className="border-2 border-white text-white hover:bg-white hover:text-blue-800 font-bold py-4 px-10 rounded-xl text-lg transition-all flex items-center justify-center gap-2">
              Email Us
            </a>
          </div>
