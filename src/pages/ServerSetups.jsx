...
export default function ServerSetups() {
  ...
  return (
    <div className="font-sans text-gray-800 bg-white page-fade-in">
      ...
      <nav id="site-nav" className="bg-blue-50 border-b border-blue-100 sticky top-0 z-50 shadow-sm overflow-visible">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-end justify-between gap-4">
          ...
          <div className="hidden md:flex items-end gap-5 lg:gap-6 text-sm lg:text-[15px] font-semibold text-gray-700 whitespace-nowrap">
            ...
            <a href={`tel:${PHONE}`} className="inline-flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white px-4 lg:px-5 py-2 rounded-lg transition-colors font-bold shadow-sm whitespace-nowrap btn-pop">
        ...
        {menuOpen && (
          <div className="md:hidden bg-blue-50 border-t border-blue-100 px-4 pb-4">
            <div className="flex flex-col text-base font-semibold text-gray-700">
              ...
              <a href="/remote-support" className="py-3 border-b border-blue-100 hover:text-orange-500">Remote Support</a>
      ...
      {/* ── HERO ── */}
      <section className="bg-gradient-to-br from-[#1a2e5a] to-[#2563eb] text-white pt-10 pb-12 md:pt-14 md:pb-16">
        <div className="max-w-6xl mx-auto px-4 text-center">
          <p className="text-blue-200 uppercase tracking-widest text-sm font-semibold mb-3">Servers · Storage · Networking</p>
          <h1 className="text-4xl md:text-6xl font-extrabold leading-tight mb-5">
            Server Setups That <span className="text-orange-400">Just Work.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href={`tel:${PHONE}`} className="bg-orange-500 hover:bg-orange-600 text-white font-bold py-4 px-8 rounded-xl text-lg transition-all shadow-lg flex items-center justify-center gap-2 btn-pop">
              <Phone className="w-5 h-5" /> Call {PHONE}
            </a>
            <a href="#server-services" className="border-2 border-white text-white hover:bg-white hover:text-blue-800 font-bold py-4 px-8 rounded-xl text-lg transition-all flex items-center justify-center gap-2 btn-pop">
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-extrabold text-[#1a2e5a] mb-3">Sound Familiar?</h2>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {SITUATIONS.map((item, i) => (
              <div key={i} className="flex items-start gap-3 bg-blue-50 border border-blue-100 rounded-xl p-4">
                ...
                <span className="text-[#1a2e5a] font-medium">{item}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 md:py-20 bg-[#002868]">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-blue-200 max-w-xl mx-auto text-lg">A server is the heart of your office. It should be set up by someone who'll still be around to answer the phone.</p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-extrabold text-[#1a2e5a] mb-3">How It Works</h2>
      ...
      {/* ── BIG CTA ── */}
      <section className="py-16 md:py-20 bg-gradient-to-br from-[#1a2e5a] to-[#2563eb] text-white">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <Server className="w-12 h-12 text-orange-400 mx-auto mb-5" />
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href={`tel:${PHONE}`} className="bg-orange-500 hover:bg-orange-600 text-white font-bold py-4 px-10 rounded-xl text-lg transition-all shadow-lg flex items-center justify-center gap-2 btn-pop">
              <Phone className="w-5 h-5" /> Call {PHONE}
            </a>
            <a href={`mailto:${EMAIL}`} className="border-2 border-white text-white hover:bg-white hover:text-blue-800 font-bold py-4 px-10 rounded-xl text-lg transition-all flex items-center justify-center gap-2 btn-pop">
              Email Us
            </a>
          </div>
