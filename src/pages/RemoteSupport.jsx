    ...
    <div className="min-h-screen bg-gray-50 text-gray-800 page-fade-in">
      ...
      <nav id="site-nav" className="bg-blue-50 border-b border-blue-100 sticky top-0 z-50 shadow-sm overflow-visible">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between gap-4">
          <a href="/" className="leading-none flex-shrink-0 flex items-center">
      ...
      <section className="py-8 md:py-10 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          <p className="text-orange-500 uppercase tracking-widest text-sm font-semibold text-center mb-2">Remote Support</p>
          <h2 className="text-2xl md:text-3xl font-extrabold text-[#1a2e5a] text-center mb-3">How It Works</h2>
          <p className="text-gray-500 text-center text-base md:text-lg max-w-2xl mx-auto mb-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="text-center">
                <div className="w-12 h-12 rounded-full bg-blue-100 text-[#1a2e5a] flex items-center justify-center mx-auto mb-3">
                  <s.icon className="w-6 h-6" />
                </div>
                <h3 className="font-bold text-lg text-[#1a2e5a] mb-1.5">{s.title}</h3>
