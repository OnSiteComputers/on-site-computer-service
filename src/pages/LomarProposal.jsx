...
const SIGN_URL = "https://www.jotform.com/sign/261697443569069/invite/01kvh4b2an87e3c2caa8e966b1";
...
const PLANS = [
  {
    ...
    monthly: "$1,498",
    total: "$8,988",
    totalLabel: "paid in full · $1,498/mo × 6 months",
    savings: null,
    payUrl: "https://securelink-prod.valorpaytech.com:4430/?redirect=1&uid=a8728257-6c25-11f1-8d9b-128462456e49",
  },
  {
    key: "ess12",
    plan: "Essential",
    ...
    monthly: "$1,498",
    total: "$16,478",
    totalLabel: "paid in full · save $1,498 (one month free)",
    savings: "Save $1,498 — One Month Free",
    payUrl: "https://securelink-prod.valorpaytech.com:4430/?redirect=1&uid=43dbcd80-6c21-11f1-8d9b-128462456e49",
    featured: true,
  },
  {
    key: "plus6",
    ...
    monthly: "$2,354",
    total: "$14,124",
    totalLabel: "paid in full · $2,354/mo × 6 months",
    savings: null,
    payUrl: "https://securelink-prod.valorpaytech.com:4430/?redirect=1&uid=e70068c0-6c26-11f1-8d9b-128462456e49",
  },
  {
    key: "plus12",
    plan: "Priority Plus",
    ...
    monthly: "$2,354",
    total: "$25,894",
    totalLabel: "paid in full · save $2,354 (one month free)",
    savings: "Save $2,354 — One Month Free",
    payUrl: "https://securelink-prod.valorpaytech.com:4430/?redirect=1&uid=ca4f4765-6c21-11f1-8d9b-128462456e49",
    featured: true,
  },
];
  ...
  return (
    <div style={{ background: "#f7f8fa", minHeight: "100vh", color: NAVY }}>
      <style>{`
        ...
        .lomar-group-label { font-size: 12px; font-weight: 800; letter-spacing: .12em; text-transform: uppercase; color: #fff; background: ${NAVY}; padding: 6px 14px; border-radius: 20px; display: inline-block; margin: 32px 0 12px; }
        ...
        .lomar-savings { font-size: 13px; font-weight: 700; color: #16a34a; background: #dcfce7; border-radius: 6px; padding: 4px 10px; display: inline-block; margin: 0 0 14px; }
      ...
      <div className="lomar-wrap">
        <header className="lomar-hero">
          ...
          <p className="lomar-sub">
            ...
            Every plan locks in faster response, lower emergency rates, and no trip charges. Choose 12 months and get <strong>one month free</strong>.
          </p>
        </header>
        ...
        <span className="lomar-group-label">Essential — Up to 5 hrs/mo</span>
        <div className="lomar-cards">
          {PLANS.filter(p => p.plan === "Essential").map((p) => (
            <div className={`lomar-card${p.featured ? " featured" : ""}`} key={p.key}>
              {p.featured && <span className="lomar-flag">Best Value</span>}
              ...
              <p className="lomar-total-label">{p.totalLabel}</p>
              {p.savings && <span className="lomar-savings">&#10003; {p.savings}</span>}
        ...
        <span className="lomar-group-label" style={{ marginTop: 28 }}>Priority Plus — Up to 10 hrs/mo</span>
        <div className="lomar-cards">
          {PLANS.filter(p => p.plan === "Priority Plus").map((p) => (
            <div className={`lomar-card${p.featured ? " featured" : ""}`} key={p.key}>
              {p.featured && <span className="lomar-flag">Best Value</span>}
              <p className="lomar-plan">{p.plan}</p>
              <p className="lomar-term">{p.term}</p>
        ...
        <p className="lomar-note">
          ...
          <b> Debit card</b> payments have no surcharge. Prices include applicable NC sales tax.
        </p>
