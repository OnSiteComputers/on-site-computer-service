...
const SIGN_URL = "https://www.jotform.com/sign/261709234102044/invite/01kvm36dy27cf17b5443b90d2d";
    ...
    <div style={{ background: "#f7f8fa", minHeight: "100vh", color: NAVY }}>
      ...
      <div className="lomar-wrap">
        ...
        <p className="lomar-note">
          ...
          term. A processing surcharge applies to <b>credit card</b> payments and is shown at checkout
          before you confirm — <b>debit card</b> payments have no surcharge. Prices include applicable NC sales tax.
        </p>
