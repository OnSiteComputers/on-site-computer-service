...
const SIGN_URL = "https://www.jotform.com/sign/261709296678070/invite/01kvm2bzcyc160a2c80e9b74b5";
...
const PLANS = [
  {
    ...
    firstMonth: "$1,498",
    payUrl:
      "https://securelink-prod.valorpaytech.com:4430/?redirect=1&uid=2150616f-6d1b-11f1-8d9b-128462456e49",
  },
  {
    key: "priority",
    plan: "Priority Plus",
    ...
    firstMonth: "$2,354",
    payUrl:
      "https://securelink-prod.valorpaytech.com:4430/?redirect=1&uid=3dd5be55-6d1b-11f1-8d9b-128462456e49",
    featured: true,
  },
];
  ...
  return (
    <div style={{ background: "#f7f8fa", minHeight: "100vh", color: NAVY }}>
      ...
      <div className="lomar-wrap">
        ...
        <p className="lomar-note">
          Your first month is paid through the button above. After that, monthly billing is set up to
          run automatically on the same date each month for the term. A processing surcharge applies to
          <b> credit card</b> payments and is shown at checkout before you confirm — <b>debit card</b> payments
          have no surcharge. Prices include applicable NC sales tax.
        </p>
